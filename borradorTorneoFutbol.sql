...
CREATE PROCEDURE generar_direccion_sc
AS
BEGIN
  DECLARE @id INT;
...
BEGIN
    ...
    SELECT * FROM ProgramaPartido ORDER BY fecha_programada
	SELECT * FROM Alineacion ORDER BY fecha
END
...
BEGIN
	...
	OPEN cursor5;
	FETCH NEXT FROM cursor5 INTO @id_detalle_alineacion
